                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Expanded(child: Column(
                      ...
                      children: [
                        SizedBox(height: 15,),
                        CustomText(label: 'Rural Metro Fire', size: TextSize.medium, weight: FontWeight.w600, fontType:GoogleFonts.jost),
                        SizedBox(height: 6,),
                        CustomText(label: 'Protect thousands of\n'
                            'people. In this case study\n'
                            'you will...more', size: TextSize.medium, weight: FontWeight.w400, fontType: GoogleFonts.jost,color: Color(0xff000000),)
                      ],
                    ))
                  ],
                ),
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Expanded(child: Column(
                      ...
                      children: [
                        SizedBox(height: 15,),
                        CustomText(label: 'Barmer', size: TextSize.medium, weight: FontWeight.w600, fontType:GoogleFonts.jost),
                        SizedBox(height: 6,),
                        CustomText(label: 'Safed 100k in bill. In this\n'
                            'case study you^ll see\n'
                            'how...more', size: TextSize.medium, weight: FontWeight.w400, fontType: GoogleFonts.jost,color: Color(0xff000000),)
                      ],
                    ))
                  ],
                ),
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Expanded(child: Column(
                      ...
                      children: [
                        SizedBox(height: 15,),
                        CustomText(label: 'Solvbox', size: TextSize.medium, weight: FontWeight.w600, fontType:GoogleFonts.jost),
                        SizedBox(height: 6,),
