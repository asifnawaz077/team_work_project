        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: TextField(
                decoration: InputDecoration(
                    hintText: 'Alexander schee', border: InputBorder.none),
              ),
            ),
            SizedBox(
              height: 20,
            ...
            Container(
              ...
              child: TextField(
                decoration: InputDecoration(
                    hintText: '@alexanderscschee', border: InputBorder.none),
              ),
            ),
            SizedBox(
              height: 20,
            ...
            Container(
                ...
                child: CustomText(
                  label: 'I provide tailored solution to help you overcome\n'
            ...
            Container(
              ...
              child: TextField(
                decoration: InputDecoration(
                    hintText: 'Germany', border: InputBorder.none),
              ),
            ),
            SizedBox(
              height: 20,
            ...
            Container(
              ...
              child: TextField(
                decoration: InputDecoration(
                    hintText: 'Designing', border: InputBorder.none),
              ),
            ),
            SizedBox(
              height: 20,
            ...
            Container(
              ...
              child: TextField(
                decoration: InputDecoration(
                    hintText: 'Solvbox', border: InputBorder.none),
              ),
            ),
            SizedBox(
              height: 20,
            ...
            Container(
              ...
              child: TextField(
                decoration: InputDecoration(
                    hintText: '001 123 4567', border: InputBorder.none),
              ),
            ),
            SizedBox(
              height: 20,
            ...
            Container(
              ...
              child: TextField(
                decoration: InputDecoration(
                    hintText: 'www.solvbox.com', border: InputBorder.none),
              ),
            ),
            SizedBox(
              height: 70,
